...
const ModelSwitcher = () => {
  ...
  return (
    <button
      onClick={nextModel}
      className="fixed top-1/2 -translate-y-1/2 right-0 z-50 flex flex-col items-center justify-center bg-model transition-all duration-300 w-[12.5vw] aspect-square rounded-full pr-[7vw] translate-x-[60%]"
    >
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 flex justify-end translate-anim">
          <div className="size-full shrink-0 grid place-items-center">
            <svg viewBox="0 0 13.63 13.63" className="w-[0.9vw]">
        ...
        <svg viewBox="0 0 19.26 37.44" className="w-[1.56vw]">
      ...
      <svg viewBox="0 0 35.8 7.7" className="w-[2.4vw]">
